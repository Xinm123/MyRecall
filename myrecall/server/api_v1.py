...
from myrecall.server.runtime_config import _mask_api_key  # single source of truth
...
def get_description_settings():
    ...
    from myrecall.server.runtime_config import get_effective_description_settings
...
def update_description_settings():
    ...
    from myrecall.server.ai.factory import invalidate as factory_invalidate
