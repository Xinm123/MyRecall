...
if TYPE_CHECKING:
    from myrecall.server.description.providers.base import DescriptionProvider
    from myrecall.server.embedding.providers.base import MultimodalEmbeddingProvider

from myrecall.server.ai.base import (
    AIProvider,
    AIProviderConfigError,
    EmbeddingProvider,
    OCRProvider,
)
from myrecall.server.ai.providers import (
...
def get_description_provider() -> "DescriptionProvider":
    ...
    with _lock:
        ...
        from myrecall.server.description.providers import (
            LocalDescriptionProvider,
            OpenAIDescriptionProvider,
            DashScopeDescriptionProvider,
        )
        from myrecall.server.runtime_config import (
...
def get_multimodal_embedding_provider() -> "MultimodalEmbeddingProvider":
    ...
    """
    from myrecall.server.embedding.providers import (
