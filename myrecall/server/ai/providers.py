...
from myrecall.server.nlp import get_nlp_engine
# from myrecall.server.ocr import extract_text_from_image
...
class DoctrOCRProvider(OCRProvider):
    def extract_text(self, image_path: str) -> str:
        ...
        try:
            from myrecall.server.ocr.doctr_backend import extract_text_from_image
        except ImportError as e:
            raise AIProviderUnavailableError(
