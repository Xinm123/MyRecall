...
from myrecall.client.events.macos import (
...
def _merge_accessibility_metadata(
    ...
    decision: "myrecall.client.accessibility.types.AccessibilityDecision",  # noqa: F821
    ...
    def run_capture_loop(self) -> None:
        ...
        while not self._stop_requested:
            ...
            try:
                ...
                ax_debug_dir = None
                if os.environ.get("MYRECALL_ACCESSIBILITY_DEBUG"):
