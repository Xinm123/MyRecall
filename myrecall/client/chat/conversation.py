...
# Storage path: MYRECALL_CLIENT_DATA_DIR/chats/ or ~/.myrecall/client/chats/
_CLIENT_DATA_DIR = Path(os.environ.get("MYRECALL_CLIENT_DATA_DIR", Path.home() / ".myrecall" / "client"))
