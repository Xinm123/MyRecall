...
SUPPORTED_PROVIDERS = [
    ...
    },
    {
        ...
        "url": "",
        "api_base": "",  # loaded from MYRECALL_CHAT_API_BASE or ~/.pi/agent/auth.json
        "models": [
...
def get_chat_api_base() -> str:
    ...
    Priority:
      1. Environment variable MYRECALL_CHAT_API_BASE
      2. ~/.pi/agent/auth.json custom.api_base
      3. "" (empty, uses provider default)
    """
    if env_val := os.environ.get("MYRECALL_CHAT_API_BASE"):
