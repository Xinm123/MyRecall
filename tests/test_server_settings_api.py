...
from myrecall.server.ai import factory
...
class TestServerSettingsAPI:
    ...
    def test_post_sqlite_failure_returns_500(self, client):
        from myrecall.server import runtime_config as rc
    ...
    def test_test_endpoint_does_not_write(self, client):
        with patch("myrecall.server.api_v1._probe_provider") as mock_probe:
    ...
    def test_test_endpoint_success(self, client):
        ...
        with patch("myrecall.server.api_v1.requests.get") as mock_get:
            mock_resp = MagicMock()
    ...
    def test_test_endpoint_returns_ok_false_on_network_error(self, client):
        ...
        with patch(
            "myrecall.server.api_v1.requests.get",
    ...
    def test_test_endpoint_uses_runtime_api_key_when_omitted(self, client):
        ...
        with patch("myrecall.server.api_v1.requests.get", side_effect=fake_get):
            resp = client.post(
                "/v1/settings/description/test",
                data=json.dumps({
                    "provider": "openai",
